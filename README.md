...
<img src="app/src/main/ic_launcher-playstore.png" width="96" height="96" alt="ToolixHub App Icon" />
...
### 🔍 QR & Utility Tools
- **QR Code Generator**: Generate custom QR codes for Text/URLs, Wi-Fi networks, and Email payloads. Generated QR codes can be saved directly to the device gallery (`Pictures/ToolixHub`).
- **QR Code Scanner**: Camera-based QR code and barcode scanner.
...
### ⚡ App Personalization & Management
...
- **Manual Release Updates**: Manual GitHub release update checker built into Settings → About.
...
<div align="center">
  <table>
    <tr>
      <td align="center">
        <img src="App%20view/home_v2.png" width="210" alt="Home Dashboard" /><br />
        <sub><b>Home Dashboard</b></sub>
      </td>
      <td align="center">
        <img src="App%20view/calculator.png" width="210" alt="Standard Calculator" /><br />
        <sub><b>Standard Calculator</b></sub>
      </td>
    </tr>
    <tr>
      <td align="center">
        <img src="App%20view/Age_claculator.png" width="210" alt="Age Calculator" /><br />
        <sub><b>Age Calculator</b></sub>
      </td>
      <td align="center">
        <img src="App%20view/curency.png" width="210" alt="Currency Converter" /><br />
...
- 🔗 **Repository**: [https://github.com/Zykrave/ToolixHub](https://github.com/Zykrave/ToolixHub)
- 📦 **Official Releases**: [https://github.com/Zykrave/ToolixHub/releases](https://github.com/Zykrave/ToolixHub/releases)

**How Software Updates Work:**
- ToolixHub includes an optional manual update checker located under **Settings → About**.
...
### Requirements & SDK Specifications
...
3. To build a debug APK via command line:
   - On Linux / macOS:
     ```bash
...
- **Debug Builds**: Debug builds work out-of-the-box using the pre-configured `debug.keystore` supplied in the project root directory.
- **Release Builds**: Release builds require setting the environment variables `KEYSTORE_PATH`, `STORE_PASSWORD`, and `KEY_PASSWORD` to point to your signing key.
...
- **Explicit Network Use Only**: Network access exists specifically for the user-initiated software update check in **Settings → About**. The app does not continuously contact a server for normal tool usage, and your personal data or generated content is never uploaded.
...
The complete license is available in the [`LICENSE`](LICENSE) file.

For the official license text online, see the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
